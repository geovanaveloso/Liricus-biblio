...
import br.controller.ContatoFacade;
...
public class ContatoController implements Serializable {
    ...
    @EJB
    private br.controller.ContatoFacade ejbFacade;
    ...
    public Contato createContato(String site, String email, String nome) {
    ...
    public String create(Contato cont) {
        try {
            getFacade().create(cont);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ContatoCreated"));
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
